...
flag -Dlog4j.configuration=<log4j configuration file> to the java call
	...
	Example: Run with the INFO level we can use the  edu/umd/cs/guitar/log/guitar-clean.glc configuration file instead of the default one (compressed in guitar-core.jar)
