...
- (void)viewDidLoad {
	...
	[listOfMovies addObject:@"Eternal Sunshine of the Spotless Mind"];
	[listOfMovies addObject:@"Remember the Titans"];
	[listOfMovies addObject:@"The Social Network"];
	[listOfMovies addObject:@"Rush Hour"];
	[listOfMovies addObject:@"Star Wars"];
