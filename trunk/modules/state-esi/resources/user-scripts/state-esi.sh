...
##################################
function usage {
	echo "Usage: $0 -l1 <length-1 oracle dir>"
}
...
# Main classes 
stateesi_launcher=edu.umd.cs.guitar.state.StateESI
...
STATEESI_CMD="$JAVA_CMD_PREFIX $GUITAR_OPTS -cp $classpath $stateesi_launcher $@"
$STATEESI_CMD
