...
public class EFGRenderListener implements Listener, MenuListener{
	...
	public EFGRenderListener(Widget widget,Map<EdgeType, Set<WidgetId>> neighbors, Color blue, Color green)
	{
		...
		//GUITARLog.log.info(neighbors.get(EdgeType.REACHING));
...
/*		GUITARLog.log.info(widgets);
		GUITARLog.log.info(neighbors);*/
		//GUITARLog.log.info(VisualizationGenerator.widgetList.get(widget)+" "+widgets);
