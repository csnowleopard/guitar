...
public class EventFlowGraph {
	...
	void addEvent(EFGEvent event) {
		if(event == null) { 
			GUITARLog.log.info("Trying to add null event to EFG"); 
	...
	public WidgetId getWidgetFromEvent(EventId eventID)
	{
		...
		return null;
			...
			GUITARLog.log.info("Cannot find event for eventID: " + eventID); 
			return null; 
		}
	}
	...
	public Map<EdgeType, Set<WidgetId>> getFollowingWidgets(WidgetId widgetId) {
		...
		return followingWidgets;
			...
			GUITARLog.log.info("No widget found for widgetID" + widgetId); 
			return null; 
		}
	}
	...
	public enum EdgeType {
		...
		public static EdgeType parse(int num) {
			...
			case 2:
				return REACHING;
			default:
				GUITARLog.log.info(num + " is not a valid edge");
				return null; 
			}
		}
