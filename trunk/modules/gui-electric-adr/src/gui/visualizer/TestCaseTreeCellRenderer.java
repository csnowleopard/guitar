...
public class TestCaseTreeCellRenderer extends DefaultTreeCellRenderer {
	 ...
	 */
	ImageIcon invalidTestCaseIcon = new ImageIcon(getClass().getResource("/resources/invalidTestCaseIcon.png"));

	/**
	 * Icon associated with invalid test case steps.
	 */
	ImageIcon invalidTestCaseStepIcon = new ImageIcon(getClass().getResource("/resources/invalidTestCaseStepIcon.png"));

	/**
	 * Icon associated with valid test cases.
	 */
	ImageIcon validTestCaseIcon = new ImageIcon(getClass().getResource("/resources/validTestCaseIcon.png"));

	/**
	 * Icon associated with valid test cases steps.
	 */
	ImageIcon validTestCaseStepIcon = new ImageIcon(getClass().getResource("/resources/validTestCaseStepIcon.png"));
