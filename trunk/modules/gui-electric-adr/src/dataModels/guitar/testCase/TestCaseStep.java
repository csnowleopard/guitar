package dataModels.guitar.testCase;
...
public class TestCaseStep {
	...
	/**
	 * Integer value representing this TestCaseStep number in the TestCase procedure.
	 */
	private int step;
	...
	public TestCaseStep(TestCase testCase, int stepNumber) {
		this.eventID = null;
		this.reachingStep = false;
		this.valid = true;
		this.testCase = testCase;
