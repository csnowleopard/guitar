...
# Single line command to rip the application
#cho "About to rip the application "
#cmd="./adr-ripper.sh -cp $aut_classpath -c $aut -pt $port -g $gui_file -l $log_file -m"
#echo $cmd
#eval $cmd
