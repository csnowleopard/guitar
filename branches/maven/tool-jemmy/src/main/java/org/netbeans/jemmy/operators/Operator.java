...
public abstract class Operator extends Object 
     ...
     * @param actionTimeOrigin is a timeout name to use for waiting for the action to be finished.
	...
	try {
            Object result = producer.produceAction(param, actionTimeOrigin);
     ...
     * @return an action result.
     */
    protected Object produceTimeRestricted(Action action, String actionTimeOrigin) {
